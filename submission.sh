# DPR(Retriever)
BIENCODER_FILE='retrievers/DPR/model/baseline/biencoder.pt'
EMBEDDING_FILE='retrievers/DPR/model/baseline/embedding.pickle'
...
# Other paths.
RETRIEVER_OUTPUT_FILE='retrievers/DPR/result/baseline/submit/test_aio_pt.json'
...
mkdir -p 'retrievers/DPR/result/baseline/submit'
python retrievers/DPR/dense_retriever.py \
